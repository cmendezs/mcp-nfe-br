...
| `xsd_pl010d_cnpj_alfa/` | PL_010d (NT 2026.004 v1.01) | **Next schema** — homologation from 2026-06-01, production from 2026-07-01 | `TCnpj` becomes `[0-9A-Z]{12}[0-9]{2}`; `TChNFe` (access key) becomes `[0-9]{6}[0-9A-Z]{12}[0-9]{26}`. |
...
- NT Conjunta DFe 2025.001 (primary source for CNPJ alfanumérico check-digit algorithm)
